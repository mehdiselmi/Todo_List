...
const Todo = () => {
  ...
  return (
    <div
      className={`transition-all duration-500 ${dark ? "bg-slate-50" : "bg-slate-900"} h-screen w-full pt-10`}
    >
      <div
      ...
      >
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1
              className={`font-bold text-2xl ${dark ? "text-slate-700" : "text-white"}`}
            >
              Your ToDo
            </h1>
          </div>
          <div
            ...
            className="cursor-pointer p-2 rounded-full hover:bg-orange-500/10 transition-colors"
          >
            {dark ? (
              <MdDarkMode className="text-2xl text-slate-600" />
            ) : (
              <MdOutlineLightMode className="text-2xl text-orange-400" />
            )}
          </div>
        </div>
        ...
        {/*------------- text field ---------------- */}
        <div
          className={`flex items-center ${dark ? "bg-slate-100" : "bg-slate-700"} h-12 mt-2 rounded-xl overflow-hidden border border-transparent focus-within:border-orange-500 transition-all`}
        >
          <input
            type="text"
            value={task}
        ...
        <div className="mt-8 space-y-3 max-h-78.75  custom-scrollbar overflow-y-auto ">
          {todoList.map((item, index) => (
            ...
            >
              ...
              <div className="flex gap-3 items-center">
                <FaPen
                  className="cursor-pointer text-sky-500 hover:text-sky-400 transition-colors text-sm"
          ...
          {todoList.length === 0 && (
            <p className="text-center text-slate-500 mt-10 italic text-sm">
              Your list is empty...
            </p>
          )}
        </div>
